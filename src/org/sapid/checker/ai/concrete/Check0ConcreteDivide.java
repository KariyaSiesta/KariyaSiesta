...
import org.sapid.checker.ai.AIDivide;
 ...
 *
 */
public class Check0ConcreteDivide extends AIDivide {
	 ...
	 * @param right_value
	 */
	public Check0ConcreteDivide(Value left_value, Value right_value, Element elem) {
