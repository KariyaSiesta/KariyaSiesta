...
public class IsSigned implements XPathFunction {

	private static IsSigned instance;
	...
	public static IsSigned getInstance() {
		if (instance == null) {
			instance = new IsSigned();
		}
	...
	public Boolean evaluate(List args) throws XPathFunctionException {
		...
		if (type.getSort() == Type.Sort.STANDARD) {
			return ((StandardType) type).getSign() == StandardType.Sign.SIGNED;
		} else {
			return false;
		}
	}
