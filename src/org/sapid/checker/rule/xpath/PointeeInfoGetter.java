...
public class PointeeInfoGetter implements XPathFunction {

	private static PointeeInfoGetter instance;
	
	
	private PointeeInfoGetter() {
	}
	
	
	public static PointeeInfoGetter getInstance() {
		if (instance == null) {
			instance = new PointeeInfoGetter();
		}
	...
	public Element evaluate(List args) throws XPathFunctionException {
		...
		return pointeeType.getTypeInfoElement();
	}
