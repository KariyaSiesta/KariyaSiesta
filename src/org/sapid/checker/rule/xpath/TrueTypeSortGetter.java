...
public class TrueTypeSortGetter implements XPathFunction {
	
	private static TrueTypeSortGetter instance;
	
	
	private TrueTypeSortGetter() {
	}
	
	
	public static TrueTypeSortGetter getInstance() {
		if (instance == null) {
			instance = new TrueTypeSortGetter();
		}
