...
/**
 * 式（Expr要素）がシフト（>>= なども）式かどうかを調べるXPath関数
 * @author uehara
 */
public class IsShift implements XPathFunction {

	private static IsShift instance;
	...
	public static IsShift getInstance() {
		if (instance == null) {
			instance = new IsShift();
		}
	...
	public Boolean evaluate(List args) throws XPathFunctionException {
		...
		return sort == CExpressionElement.Sort.SHIFT || sort == CExpressionElement.Sort.SHIFT_ASSIGN;
	}
