...
public class SignGetter implements XPathFunction {

	private static SignGetter instance;
	...
	public static SignGetter getInstance() {
		if (instance == null) {
			instance = new SignGetter();
		}
	...
	public String evaluate(List args) throws XPathFunctionException {
		...
		if (type.getSort() == Type.Sort.STANDARD) {
			return ((StandardType) type).getSign().toString();
		} else {
			return "";
		}
	}
