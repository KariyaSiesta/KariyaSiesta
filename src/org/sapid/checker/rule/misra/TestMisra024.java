/* 
 * Program:             $RCSfile: TestMisra024.java,v $  $Revision: 60.2 $
 * 
 *
...
/* 
 * $Id: TestMisra024.java,v 60.2 2010/06/28 06:14:16 yamamoto Exp yamamoto $
 */
...
public class TestMisra024 extends TestMisra {
    public TestMisra024(String name) {
	super(name);
	RULE_ID = 24;
    }
