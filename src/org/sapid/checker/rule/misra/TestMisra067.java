/* 
 * Program:             $RCSfile: TestMisra067.java,v $  $Revision: 60.2 $
 * 
 *
...
/* 
 * $Id: TestMisra067.java,v 60.2 2010/06/28 06:14:16 yamamoto Exp yamamoto $
 */
...
public class TestMisra067 extends TestMisra {
    public TestMisra067(String name) {
	super(name);
	RULE_ID = 67;
    }
