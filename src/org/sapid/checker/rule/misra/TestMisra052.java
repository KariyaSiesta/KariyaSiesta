/* 
 * Program:             $RCSfile: TestMisra052.java,v $  $Revision: 60.2 $
 * 
 *
...
/* 
 * $Id: TestMisra052.java,v 60.2 2010/06/28 06:14:16 yamamoto Exp yamamoto $
 */
...
public class TestMisra052 extends TestMisra {
    public TestMisra052(String name) {
	super(name);
	RULE_ID = 52;
    }
