/* 
 * Program:             $RCSfile: TestMisra032.java,v $  $Revision: 60.2 $
 * 
 *
...
/* 
 * $Id: TestMisra032.java,v 60.2 2010/06/28 06:14:16 yamamoto Exp yamamoto $
 */
...
public class TestMisra032 extends TestMisra {
    public TestMisra032(String name) {
	super(name);
	RULE_ID = 32;
    }
