/* 
 * Program:             $RCSfile: TestMisra088.java,v $  $Revision: 60.2 $
 * 
 *
...
/* 
 * $Id: TestMisra088.java,v 60.2 2010/06/28 06:14:16 yamamoto Exp yamamoto $
 */
...
public class TestMisra088 extends TestMisra {
    public TestMisra088(String name) {
	super(name);
	RULE_ID = 88;
    }
