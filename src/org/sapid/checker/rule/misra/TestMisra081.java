/* 
 * Program:             $RCSfile: TestMisra081.java,v $  $Revision: 60.2 $
 * 
 *
...
/* 
 * $Id: TestMisra081.java,v 60.2 2010/06/28 06:14:16 yamamoto Exp yamamoto $
 */
...
public class TestMisra081 extends TestMisra {
    public TestMisra081(String name) {
	super(name);
	RULE_ID = 81;
    }
