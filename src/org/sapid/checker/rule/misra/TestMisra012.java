/* 
 * Program:             $RCSfile: TestMisra012.java,v $  $Revision: 60.2 $
 * 
 *
...
/* 
 * $Id: TestMisra012.java,v 60.2 2010/06/28 06:14:16 yamamoto Exp yamamoto $
 */
...
public class TestMisra012 extends TestMisra {
    public TestMisra012(String name) {
	super(name);
	RULE_ID = 12;
    }
