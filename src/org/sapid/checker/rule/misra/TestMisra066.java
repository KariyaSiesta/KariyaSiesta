/* 
 * Program:             $RCSfile: TestMisra066.java,v $  $Revision: 60.2 $
 * 
 *
...
/* 
 * $Id: TestMisra066.java,v 60.2 2010/06/28 06:14:16 yamamoto Exp yamamoto $
 */
...
public class TestMisra066 extends TestMisra {
    public TestMisra066(String name) {
	super(name);
	RULE_ID = 66;
    }
