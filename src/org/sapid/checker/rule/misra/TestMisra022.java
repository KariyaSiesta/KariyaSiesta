/* 
 * Program:             $RCSfile: TestMisra022.java,v $  $Revision: 60.2 $
 * 
 *
...
/* 
 * $Id: TestMisra022.java,v 60.2 2010/06/28 06:14:16 yamamoto Exp yamamoto $
 */
...
public class TestMisra022 extends TestMisra {
    public TestMisra022(String name) {
	super(name);
	RULE_ID = 22;
    }
