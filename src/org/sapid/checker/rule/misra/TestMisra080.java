/* 
 * Program:             $RCSfile: TestMisra080.java,v $  $Revision: 60.2 $
 * 
 *
...
/* 
 * $Id: TestMisra080.java,v 60.2 2010/06/28 06:14:16 yamamoto Exp yamamoto $
 */
...
public class TestMisra080 extends TestMisra {
    public TestMisra080(String name) {
	super(name);
	RULE_ID = 80;
    }
