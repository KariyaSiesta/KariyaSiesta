/* 
 * Program:             $RCSfile: TestMisra096.java,v $  $Revision: 60.2 $
 * 
 *
...
/* 
 * $Id: TestMisra096.java,v 60.2 2010/06/28 06:14:16 yamamoto Exp yamamoto $
 */
...
public class TestMisra096 extends TestMisra {
    public TestMisra096(String name) {
	super(name);
	RULE_ID = 96;
    }
