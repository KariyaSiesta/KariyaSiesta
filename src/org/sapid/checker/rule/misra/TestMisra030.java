/* 
 * Program:             $RCSfile: TestMisra030.java,v $  $Revision: 60.2 $
 * 
 *
...
/* 
 * $Id: TestMisra030.java,v 60.2 2010/06/28 06:14:16 yamamoto Exp yamamoto $
 */
...
public class TestMisra030 extends TestMisra {
    public TestMisra030(String name) {
	super(name);
	RULE_ID = 30;
    }
