/* 
 * Program:             $RCSfile: TestMisra072.java,v $  $Revision: 60.2 $
 * 
 *
...
/* 
 * $Id: TestMisra072.java,v 60.2 2010/06/28 06:14:16 yamamoto Exp yamamoto $
 */
...
public class TestMisra072 extends TestMisra {
    public TestMisra072(String name) {
	super(name);
	RULE_ID = 72;
    }
