/* 
 * Program:             $RCSfile: TestMisra082.java,v $  $Revision: 60.2 $
 * 
 *
...
/* 
 * $Id: TestMisra082.java,v 60.2 2010/06/28 06:14:16 yamamoto Exp yamamoto $
 */
...
public class TestMisra082 extends TestMisra {
    public TestMisra082(String name) {
	super(name);
	RULE_ID = 82;
    }
