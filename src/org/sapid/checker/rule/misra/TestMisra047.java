/* 
 * Program:             $RCSfile: TestMisra047.java,v $  $Revision: 60.2 $
 * 
 *
...
/* 
 * $Id: TestMisra047.java,v 60.2 2010/06/28 06:14:16 yamamoto Exp yamamoto $
 */
...
public class TestMisra047 extends TestMisra {
    public TestMisra047(String name) {
	super(name);
	RULE_ID = 47;
    }
