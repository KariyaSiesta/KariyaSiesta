/* 
 * Program:             $RCSfile: TestMisra053.java,v $  $Revision: 60.2 $
 * 
 *
...
/* 
 * $Id: TestMisra053.java,v 60.2 2010/06/28 06:14:16 yamamoto Exp yamamoto $
 */
...
public class TestMisra053 extends TestMisra {
    public TestMisra053(String name) {
	super(name);
	RULE_ID = 53;
    }
