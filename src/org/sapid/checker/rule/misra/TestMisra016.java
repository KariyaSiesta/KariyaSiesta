/* 
 * Program:             $RCSfile: TestMisra016.java,v $  $Revision: 60.2 $
 * 
 *
...
/* 
 * $Id: TestMisra016.java,v 60.2 2010/06/28 06:14:16 yamamoto Exp yamamoto $
 */
...
public class TestMisra016 extends TestMisra {
    public TestMisra016(String name) {
	super(name);
	RULE_ID = 16;
    }
