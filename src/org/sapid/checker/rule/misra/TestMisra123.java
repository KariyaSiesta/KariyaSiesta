/* 
 * Program:             $RCSfile: TestMisra123.java,v $  $Revision: 60.2 $
 * 
 *
...
/* 
 * $Id: TestMisra123.java,v 60.2 2010/06/28 06:14:16 yamamoto Exp yamamoto $
 */
...
public class TestMisra123 extends TestMisra {
    public TestMisra123(String name) {
	super(name);
	RULE_ID = 123;
    }
