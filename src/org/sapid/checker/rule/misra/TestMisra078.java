/* 
 * Program:             $RCSfile: TestMisra078.java,v $  $Revision: 60.2 $
 * 
 *
...
/* 
 * $Id: TestMisra078.java,v 60.2 2010/06/28 06:14:16 yamamoto Exp yamamoto $
 */
...
public class TestMisra078 extends TestMisra {
    public TestMisra078(String name) {
	super(name);
	RULE_ID = 78;
    }
