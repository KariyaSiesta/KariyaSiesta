/* 
 * Program:             $RCSfile: TestMisra037.java,v $  $Revision: 60.2 $
 * 
 *
...
/* 
 * $Id: TestMisra037.java,v 60.2 2010/06/28 06:14:16 yamamoto Exp yamamoto $
 */
...
public class TestMisra037 extends TestMisra {
    public TestMisra037(String name) {
	super(name);
	RULE_ID = 37;
    }
