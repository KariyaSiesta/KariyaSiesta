/* 
 * Program:             $RCSfile: TestMisra074.java,v $  $Revision: 60.2 $
 * 
 *
...
/* 
 * $Id: TestMisra074.java,v 60.2 2010/06/28 06:14:16 yamamoto Exp yamamoto $
 */
...
public class TestMisra074 extends TestMisra {
    public TestMisra074(String name) {
	super(name);
	RULE_ID = 74;
    }
