/* 
 * Program:             $RCSfile: TestMisra108.java,v $  $Revision: 60.2 $
 * 
 *
...
/* 
 * $Id: TestMisra108.java,v 60.2 2010/06/28 06:14:16 yamamoto Exp yamamoto $
 */
...
public class TestMisra108 extends TestMisra {
    public TestMisra108(String name) {
	super(name);
	RULE_ID = 108;
    }
