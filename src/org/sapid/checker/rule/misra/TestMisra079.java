/* 
 * Program:             $RCSfile: TestMisra079.java,v $  $Revision: 60.2 $
 * 
 *
...
/* 
 * $Id: TestMisra079.java,v 60.2 2010/06/28 06:14:16 yamamoto Exp yamamoto $
 */
...
public class TestMisra079 extends TestMisra {
    public TestMisra079(String name) {
	super(name);
	RULE_ID = 79;
    }
